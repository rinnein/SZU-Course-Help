function strEnc(r, e, a, n) {
	var t, s, o, c, f, m, i = r.length,
		u = "";
	if (null != e && "" != e && (t = getKeyBytes(e), c = t.length), null != a && "" != a && (s = getKeyBytes(a), f = s.length), null != n && "" != n && (o = getKeyBytes(n), m = o.length), i > 0)
		if (i < 4) {
			var l = strToBt(r);
...
function strDec(r, e, a, n) {
	var t, s, o, c, f, m, i = r.length,
		u = "";
	null != e && "" != e && (t = getKeyBytes(e), c = t.length), null != a && "" != a && (s = getKeyBytes(a), f = s.length), null != n && "" != n && (o = getKeyBytes(n), m = o.length);
	var l = parseInt(i / 16),
		b = 0;
	for (b = 0; b < l; b++) {
		var k, y = r.substring(16 * b + 0, 16 * b + 16),
			v = hexToBt64(y),
			g = new Array(64),
			w = 0;
